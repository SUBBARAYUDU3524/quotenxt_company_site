    ...
    >
      ...
      >
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="relative h-2 bg-gradient-to-r from-purple-600 to-indigo-600">
          ...
          <div className="p-8 md:p-10">
            ...
            >
              <Link href="/" className="flex items-center text-indigo-300 hover:text-white mb-4 justify-start transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                <input
                  ...
                  id="terms"
                  required
                  className="w-4 h-4 bg-white/5 border border-white/10 rounded focus:ring-indigo-500 focus:ring-offset-gray-900"
                />
            ...
            >
              ...
              <div className="relative flex justify-center">
                <span className="px-2 bg-gray-900 text-sm text-indigo-300">or sign up with</span>
              </div>
            </motion.div>
